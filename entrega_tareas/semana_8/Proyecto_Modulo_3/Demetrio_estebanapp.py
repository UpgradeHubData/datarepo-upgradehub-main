...
bmi = st.sidebar.slider(label = 'bmi', min_value = 1.0, max_value = 40.0 , value = 33.0, step = 1.0)
children = st.sidebar.slider(label = 'children', min_value = 1.0, max_value = 10.0 , value = 1.0, step = 1.0)
...
if st.button('Predict'):    
    ...
    st.write('The corretly charge evaluating the risk is  '+ str(prediction/12))
